...
public class BookController {
    ...
    public ResponseEntity<BookDTO> changeStatus(@AuthenticationPrincipal UserDTO userDTO, @PathVariable long id) {
        return ResponseEntity.ok(bookService.changeStatus(id, userDTO));
    }
}
